...
public class AccountServiceImpl implements IAccountService {
    ...
    public boolean confirm(String tid, Long userId, Long targetId, Long amount, Integer accountType, Long targetAmount, Integer targetAccountType) {
    ...
    @Transactional(rollbackFor = Exception.class)
    public boolean cancel(String tid, Long userId, Long targetId, Long amount, Integer accountType, Long targetAmount, Integer targetAccountType) {
        // 幂等处理，判断confirm表是否有记录
